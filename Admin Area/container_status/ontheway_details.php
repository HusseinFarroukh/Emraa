...
<?php
    ...
    if(!isset($_SESSION['admin_email'])){
        ...
        if(isset($_GET['ontheway_details'])){
            ...
            $container_id = $_GET['ontheway_details'];
            ...
            <form action="includes/changeToArrived.inc.php" class="form-horizontal" method="post"><!-- form-horizontal begin -->
             <div class="form-group"><!-- form-group begin -->
                        ...
                        <input value=" <?php echo $container_id; ?> " name="container" type="hidden" class="form-control">
                            <input value="Arrived" type="submit" class="form-control btn btn-primary">
                    ...
                    <div class="form-group"><!-- form-group begin -->
                     ...
                     <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input name="extra" type="text" value ="0" class="form-control" required>
