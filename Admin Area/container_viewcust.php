    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Containers by Customer
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-tags fa-fw"></i> View Containers by Customer
                        ...
                        <thead><!-- thead begin -->
                            <tr><!-- tr begin -->
                               ...
                               <!-- <th> Shipping Line </th>-->
                                ...
                                <th> Desc </th>
                                <?php 
            if ($_SESSION['admin_email'] == "steave@karoutmall.com"){echo "<th> Add Cost </th>";}?>
...
{
$cust_name=$_GET['container_viewcust'];

}
                                $get_containerList = "select b.cont_id from book b,customer c where b.cust_id=c.cust_id and b.status=1 and c.cust_name LIKE '%".$cust_name."%';";

                                $run_containerList = mysqli_query($conn,$get_containerList);

                                while($row_containerList=mysqli_fetch_array($run_containerList)){
                                    $container_ID = $row_containerList['cont_id'];

                                    $get_container = "select * from container where status = 1 AND cont_id =  ".$container_ID." ORDER BY CAST(RIGHT(cont_no, CHAR_LENGTH(cont_no)-3) AS INT) DESC";
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> <?php echo $blno; ?> </td>
                                <td> <?php echo $note; ?> </td>
                                <?php if ($_SESSION['admin_email'] == "steave@karoutmall.com"){?>
                                    <td>
